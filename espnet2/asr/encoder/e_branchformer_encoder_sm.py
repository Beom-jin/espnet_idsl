...
class EBranchformerEncoderLayer_SM(torch.nn.Module):
    ...
    def __init__(
        ...
        d_model = 256 ## E-branchformer Base Dimension = 256
        nhead = 4  ## E-branchformer Base nhead = Dimension / 64 =4 
        summary_hid_dim = 256 # = E-Branchformer Base dimension
        local_proj_hid_dim = 256 # = E-Branchformer Base dimension
        local_proj_out_dim = 256 # = E-Branchformer Base dimension
        summary_out_dim = 256 # = E-Branchformer Base dimension
